...
var es_default = {
  ...
  date: {
    days: "Domingo_Lunes_Martes_Mi\xE9rcoles_Jueves_Viernes_S\xE1bado".split("_"),
    daysShort: "Dom_Lun_Mar_Mi\xE9_Jue_Vie_S\xE1b".split("_"),
    ...
    today: "Hoy",
    prevRangeYears: (range) => `Anterior ${range} a\xF1os`,
    nextRangeYears: (range) => `Siguiente ${range} a\xF1os`
  },
  table: {
    ...
    recordsPerPage: "Filas por p\xE1gina:",
    allRows: "Todas",
  ...
  editor: {
    ...
    hyperlink: "Hiperv\xEDnculo",
    toggleFullscreen: "Alternar pantalla completa",
    quote: "Cita",
    left: "Alineaci\xF3n izquierda",
    center: "Alineaci\xF3n centro",
    right: "Alineaci\xF3n derecha",
    justify: "Justificar alineaci\xF3n",
    print: "Imprimir",
    outdent: "Disminuir indentaci\xF3n",
    indent: "Aumentar indentaci\xF3n",
    removeFormat: "Eliminar formato",
    formatting: "Formato",
    fontSize: "Tama\xF1o de Fuente",
    align: "Alinear",
    hr: "Insertar l\xEDnea horizontal",
    undo: "Deshacer",
    redo: "Rehacer",
...
// dep:quasar_lang_es_js
var quasar_lang_es_js_default = es_default;
export {
  quasar_lang_es_js_default as default
};
//# sourceMappingURL=quasar_lang_es_js.js.map
